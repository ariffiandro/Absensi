...
Route::prefix('guru')->middleware(['auth','role:guru'])->group(function () {
    ...
    Route::get('/kelas', [KelasGuruController::class, 'index'])->name('guru.kelas.index');
    Route::get('/kelas/create', [KelasGuruController::class, 'create'])->name('guru.kelas.create');
    Route::post('/kelas', [KelasGuruController::class, 'store'])->name('guru.kelas.store');
